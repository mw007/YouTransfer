...
Router.prototype.list = function() {
    return function(req, res, next) {
        ...
        // console.log("in Router.proto.list");
        ...
        //     // req.errors.parse(err);
        //     console.log("processing list.html with filelist %s", JSON.stringify(filelist));
        //     res.process('list.html', filelist, next);
        // };

        youtransfer.list(res, bundlelist);//, callback);

		// console.log("processing list.html with filelist %s", JSON.stringify(filelist));
        res.process('list.html', { bundles:bundlelist }, next);
    };
};
